    ...
    <div class="form-card mx-auto">
        ...
        <form action="agendamento.php" method="post">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="quantida_pessoas" name="quantidade_pessoas"
            ...
            <div class="mb-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="sim" id="incluir_sobremesa"
                        name="incluir_sobremesa">
                    <label class="form-check-label" for="incluirSobremesa">
                        Sobremesa
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="sim" id="incluir_drinks"
                        name="incluir_drinks">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="detalhes_pedido" name="detalhes_pedido" rows="4"
                    placeholder="Detalhe sobre os seus pedidos aqui..."></textarea>
            </div>
