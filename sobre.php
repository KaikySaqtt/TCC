                ...
                <div class="row g-4 row-cols-1 row-cols-sm-2">
                    <div class="col">
                        <div class="card h-60 shadow-sm">
                            ...
                            <div class="card-body text-center">
                                 <h5 class="card-title">Curso de grastonomia</h5>
                   ...
                   <div class="col">
                        <div class="card h-60 shadow-sm">
                            <img src="kmimagens/iga.png" class="card-img-top" alt="Jantares privativos">
                            <div class="card-body text-center">
                                 <h5 class="card-title">Curso de pâtisserie</h5>
                                <a href="https://iga-la.com/bra/cursos-de-confeitaria-no-brasil/" target="_blank" class="btn btn-km">Ver mais sobre</a>
                            </div>
                        </div>
                    </div>
