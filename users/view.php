...
if (!(isset($_SESSION['user']))) { // Verifica se tem usuário logado
...
<?php if (!empty($_SESSION['message'])) : ?>
    <div class="alert mt-4 alert-<?php echo $_SESSION['type']; ?> alert-dismissible" role="alert" id="actions">
...
<?php if ($usuario) : ?>
    ...
    <dl class="dl-horizontal">
        ...
        <dt>Login:</dt>
        <dd><?php echo $usuario['username']; ?></dd>
